...
const socials = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: "clamp(2rem,4vw,3.5rem)", height: "clamp(2rem,4vw,3.5rem)" }}>
        <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.42c1.42.07 2.4.74 3.22.8 1.23-.24 2.4-.93 3.72-.84 1.57.12 2.75.67 3.53 1.74-3.25 1.94-2.48 6.24.48 7.43-.57 1.5-1.3 2.98-2.95 3.73zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
      </svg>
    ),
    label: "Apple Dev",
    url: "piush.dev",
